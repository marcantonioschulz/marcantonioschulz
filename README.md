...
- 🤖 **KI-Agenten** — Vertriebs-Simulation mit Voice-Agents (OpenAI Realtime API) und produktionsreife Agent-Konfigurationen für deutsche Finanzdienstleister *(privat)*
